-- TELODOX Production Migration 007: Initial Data
...
-- Note: Email templates will be tenant-specific, but we can create system defaults
-- These would be copied to new tenants during onboarding
...
-- ============================================================================
-- DEFAULT FORM FIELD TYPES AND CONFIGURATIONS
-- ============================================================================

-- Note: Form templates are tenant-specific and created by tenant owners
-- This section could include default field type configurations or examples
...
('system_initialization', 'info', 'Platform database initialized with production schema', 
